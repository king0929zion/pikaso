...
const jmcomic = (function () {
    ...
    class JmOptionImpl {
        constructor(baseDir = "/sdcard/Download/PikasoScripts") {
            this.dirRule = new DirRuleImpl(baseDir);
        }
        static default(baseDir = "/sdcard/Download/PikasoScripts") {
    ...
    class SimpleJMDownloader {
        constructor(downloadDir = "/sdcard/Download/PikasoScripts") {
