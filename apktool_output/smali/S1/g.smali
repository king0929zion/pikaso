...
.method public constructor <init>(Ljava/lang/CharSequence;Landroid/text/TextPaint;I)V
    ...
    iput p1, p0, LS1/g;->d:I

    sget-object p1, Landroid/text/Layout$Alignment;->ALIGN_NORMAL:Landroid/text/Layout$Alignment;

    iput-object p1, p0, LS1/g;->e:Landroid/text/Layout$Alignment;

    const p1, 0x7fffffff

    iput p1, p0, LS1/g;->f:I

    const/high16 p1, 0x3f800000    # 1.0f

    iput p1, p0, LS1/g;->g:F
    ...
    iput-object p1, p0, LS1/g;->k:Landroid/text/TextUtils$TruncateAt;
...
.method public final a()Landroid/text/StaticLayout;
    ...
    iput-object v0, p0, LS1/g;->a:Ljava/lang/CharSequence;
    ...
    iget-object v6, p0, LS1/g;->k:Landroid/text/TextUtils$TruncateAt;
    ...
    iget v6, p0, LS1/g;->d:I

    invoke-static {v3, v6}, Ljava/lang/Math;->min(II)I

    move-result v3

    iput v3, p0, LS1/g;->d:I

    iget-boolean v6, p0, LS1/g;->j:Z

    if-eqz v6, :cond_2

    iget v6, p0, LS1/g;->f:I

    if-ne v6, v5, :cond_2

    sget-object v6, Landroid/text/Layout$Alignment;->ALIGN_OPPOSITE:Landroid/text/Layout$Alignment;

    iput-object v6, p0, LS1/g;->e:Landroid/text/Layout$Alignment;
    ...
    iget-object v1, p0, LS1/g;->e:Landroid/text/Layout$Alignment;

    invoke-virtual {v0, v1}, Landroid/text/StaticLayout$Builder;->setAlignment(Landroid/text/Layout$Alignment;)Landroid/text/StaticLayout$Builder;

    iget-boolean v1, p0, LS1/g;->i:Z

    invoke-virtual {v0, v1}, Landroid/text/StaticLayout$Builder;->setIncludePad(Z)Landroid/text/StaticLayout$Builder;

    iget-boolean v1, p0, LS1/g;->j:Z
    ...
    iget-object v1, p0, LS1/g;->k:Landroid/text/TextUtils$TruncateAt;
    ...
    :cond_4
    iget v1, p0, LS1/g;->f:I

    invoke-virtual {v0, v1}, Landroid/text/StaticLayout$Builder;->setMaxLines(I)Landroid/text/StaticLayout$Builder;

    iget v1, p0, LS1/g;->g:F
