...
.method public final clipOutPath(Landroid/graphics/Path;)Z
    ...
    iget-object v1, p0, Lw0/v;->a:Landroid/graphics/Canvas;

    if-eqz v1, :cond_0

    invoke-virtual {v0, v1, p1}, Lw0/d;->a(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final clipOutRect(FFFF)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lw0/d;->b(Landroid/graphics/Canvas;FFFF)Z
...
.method public final clipOutRect(IIII)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lw0/d;->c(Landroid/graphics/Canvas;IIII)Z
...
.method public final clipOutRect(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lw0/d;->d(Landroid/graphics/Canvas;Landroid/graphics/Rect;)Z
...
.method public final clipOutRect(Landroid/graphics/RectF;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lw0/d;->e(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
...
.method public final clipPath(Landroid/graphics/Path;)Z
    ...
    .line 2
    iget-object v0, p0, Lw0/v;->a:Landroid/graphics/Canvas;
...
.method public final disableZ()V
    ...
    invoke-virtual {v0, v1}, Lw0/e;->a(Landroid/graphics/Canvas;)V
...
.method public final drawArc(FFFFFFZLandroid/graphics/Paint;)V
    ...
    .line 2
    iget-object v1, v0, Lw0/v;->a:Landroid/graphics/Canvas;
    ...
    invoke-static {v1}, Lp2/g;->h(Ljava/lang/String;)V
...
.method public final drawColor(ILandroid/graphics/BlendMode;)V
    ...
    invoke-virtual {v0, v1, p1, p2}, Lw0/e;->b(Landroid/graphics/Canvas;ILandroid/graphics/BlendMode;)V
...
.method public final drawColor(J)V
    ...
    invoke-virtual {v0, v1, p1, p2}, Lw0/e;->c(Landroid/graphics/Canvas;J)V
...
.method public final drawColor(JLandroid/graphics/BlendMode;)V
    ...
    invoke-virtual {v0, v1, p1, p2, p3}, Lw0/e;->d(Landroid/graphics/Canvas;JLandroid/graphics/BlendMode;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
    ...
    .line 2
    iget-object v1, v9, Lw0/v;->a:Landroid/graphics/Canvas;
    ...
    .line 3
    invoke-virtual/range {v0 .. v8}, Lw0/e;->e(Landroid/graphics/Canvas;Landroid/graphics/RectF;FFLandroid/graphics/RectF;FFLandroid/graphics/Paint;)V
...
.method public final drawDoubleRoundRect(Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
    ...
    invoke-virtual/range {v0 .. v6}, Lw0/e;->f(Landroid/graphics/Canvas;Landroid/graphics/RectF;[FLandroid/graphics/RectF;[FLandroid/graphics/Paint;)V
...
.method public final drawGlyphs([II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
    ...
    invoke-virtual/range {v0 .. v8}, Lw0/h;->a(Landroid/graphics/Canvas;[II[FIILandroid/graphics/fonts/Font;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
    ...
    invoke-virtual {v0, v1, p1, p2, p3}, Lw0/h;->b(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/Rect;Landroid/graphics/Paint;)V
...
.method public final drawPatch(Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-virtual {v0, v1, p1, p2, p3}, Lw0/h;->c(Landroid/graphics/Canvas;Landroid/graphics/NinePatch;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
...
.method public final drawRenderNode(Landroid/graphics/RenderNode;)V
    ...
    invoke-virtual {v0, v1, p1}, Lw0/e;->g(Landroid/graphics/Canvas;Landroid/graphics/RenderNode;)V
...
.method public final drawTextRun(Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 10
    iget-object v1, v11, Lw0/v;->a:Landroid/graphics/Canvas;
    ...
    .line 11
    invoke-virtual/range {v0 .. v10}, Lw0/e;->h(Landroid/graphics/Canvas;Landroid/graphics/text/MeasuredText;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final drawTextRun(Ljava/lang/CharSequence;IIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 7
    invoke-virtual/range {v0 .. v10}, Lw0/c;->a(Landroid/graphics/Canvas;Ljava/lang/CharSequence;IIIIFFZLandroid/graphics/Paint;)V
...
.method public final drawTextRun([CIIIIFFZLandroid/graphics/Paint;)V
    ...
    .line 3
    invoke-virtual/range {v0 .. v10}, Lw0/c;->b(Landroid/graphics/Canvas;[CIIIIFFZLandroid/graphics/Paint;)V
...
.method public final enableZ()V
    ...
    invoke-virtual {v0, v1}, Lw0/e;->i(Landroid/graphics/Canvas;)V
...
.method public final quickReject(FFFF)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lw0/g;->a(Landroid/graphics/Canvas;FFFF)Z
...
.method public final quickReject(Landroid/graphics/Path;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lw0/g;->b(Landroid/graphics/Canvas;Landroid/graphics/Path;)Z
...
.method public final quickReject(Landroid/graphics/RectF;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lw0/g;->c(Landroid/graphics/Canvas;Landroid/graphics/RectF;)Z
